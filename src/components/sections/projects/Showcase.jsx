  ...
  const projects = [
    {
      ...
      images: [
        projectAssets.portfoliofb.demo1,
        projectAssets.portfoliofb.demo2,
        projectAssets.portfoliofb.demo3,
        projectAssets.portfoliofb.demo4,
        projectAssets.portfoliofb.demo5,
        projectAssets.portfoliofb.demo6,
        projectAssets.portfoliofb.demo7,
        projectAssets.portfoliofb.demo8,
        projectAssets.portfoliofb.demo9,
        projectAssets.portfoliofb.demo10,
        projectAssets.portfoliofb.demo11,
        projectAssets.portfoliofb.demo12,
        projectAssets.portfoliofb.demo13,
      ],
    },
    {
      id: 2,
